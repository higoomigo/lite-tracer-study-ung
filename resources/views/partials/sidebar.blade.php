...
<aside id="sidebar" class="sidebar fixed top-0 left-0 z-40 w-64 h-screen bg-navy text-white transition-all duration-300 ease-in-out">
            <div class="h-full flex flex-col justify-between">
                <div>
                    ...
                    @if (Auth::user()->role == 'admin')
                        <nav class="mt-6 px-4">
                                <a href="{{ route('admin.dashboard') }}" class="nav-link @if(Route::is('admin.dashboard')) active @endif flex items-center px-6 py-3 text-gray-100 rounded-lg mb-1">
                               ...
                               <div class="relative">
                                    <a href="#" class="nav-link  flex items-center px-6 py-3 text-gray-300 rounded-lg mb-1" id="manageStudents">
                                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <!-- Dropdown Content -->
                                    <div id="dropdownContent" class="absolute left-0 hidden mt-2 bg-gray-800 text-white rounded-lg shadow-lg w-48">
                                        <a href="#alumni2023" class="block px-6 py-3 text-gray-300 hover:bg-gray-600">Alumni 2023</a>
                                        <a href="#alumni2024" class="block px-6 py-3 text-gray-300 hover:bg-gray-600">Alumni 2024</a>
                                    </div>
                                </div>
                                <a href="{{ route('admin.form') }}" class="nav-link @if(Route::is('admin.form')) active @endif flex items-center px-6 py-3 text-gray-300 rounded-lg mb-1">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @else
                    <nav class="mt-6 px-4">
                        <a href="{{ route('user.dashboard') }}" class="nav-link @if(Route::is('user.dashboard')) active @endif flex items-center px-6 py-3 text-gray-300 rounded-lg mb-1">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="12" cy="8" r="4" stroke="currentColor" stroke-width="2" fill="none"/>
                                <path stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M4 20c0-3.314 3.582-6 8-6s8 2.686 8 6"/>
                            </svg>
                            Profil
                        </a>
                        ...
                        <a href="{{ route('user.forms') }}" class="nav-link @if(Route::is('user.forms')) active @endif flex items-center px-6 py-3 text-gray-300 rounded-lg mb-1">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <line x1="8" y1="8" x2="16" y2="8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <line x1="8" y1="12" x2="16" y2="12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <line x1="8" y1="16" x2="12" y2="16" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            Formulir
                        </a>
