...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script src="Tracer%20Study%20-%20Universitas%20Negeri%20Gorontalo%20Super_files/3.4.16"></script>
    <link href="Tracer%20Study%20-%20Universitas%20Negeri%20Gorontalo%20Super_files/css2.css" rel="stylesheet">
    <script src="Tracer%20Study%20-%20Universitas%20Negeri%20Gorontalo%20Super_files/chart.js"></script>
    <script src="Tracer%20Study%20-%20Universitas%20Negeri%20Gorontalo%20Super_files/lottie-player.js"></script>
    <style>
        body {
    ...
    <nav class="navy text-white py-4 px-6 fixed w-full z-50">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-6">
                ...
                <a href="#statistics" class="hover:text-blue-200 transition">Statistik</a>
                <a href="#programs" class="hover:text-blue-200 transition">Program Studi</a>
                <a href="#testimonials" class="hover:text-blue-200 transition">Testimonial</a>
                <a href="#contact" class="hover:text-blue-200 transition">Kontak</a>
                <button class="btn-navy px-3 rounded-md font-semibold text-md shadow-lg">Login</button>
            </div>
            <div class="md:hidden">
