        ...
        <div class="container mx-auto px-6">
            ...
            <div class="flex justify-center mb-12 scroll-reveal active">
                <div class="inline-flex rounded-md shadow-sm bg-white">
                    <button class="year-tab px-6 py-3 text-sm font-medium rounded-l-md border-r border-gray-200 active" data-year="2019">
                        Angkatan 2019
                    </button>
                    <button class="year-tab px-6 py-3 text-sm font-medium border-r border-gray-200" data-year="2020">
                        Angkatan 2020
                    </button>
                    <button class="year-tab px-6 py-3 text-sm font-medium rounded-r-md" data-year="2021">
                        Angkatan 2021
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-12 scroll-reveal active">
                ...
                <div class="mb-6">
                    <div class="flex justify-between mb-1">
                        <span class="text-sm font-medium text-navy">Angkatan 2019</span>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-12 scroll-reveal overflow-x-auto active">
                ...
                <table class="stats-table">
                    ...
                    <tbody id="statsTableBody">
                        <tr class="year-data" data-year="2019" style="">
                            <td>2019</td>
                            <td>245</td>
                            <td>158 (64.5%)</td>
                            <td>44 (18%)</td>
    ...
    <section id="students" class="navy py-20">
        <div class="container mx-auto px-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-12 scroll-reveal active">
                ...
                <div class="mt-4 text-sm text-gray-600">
                    <p>* Data berdasarkan pencapaian mahasiswa tahun 2019-2023</p>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div class="bg-white rounded-lg shadow-lg overflow-hidden student-card">
                                <div class="p-6 text-center">
                                    ...
                                    <p class="text-gray-600 mb-2">Pendidikan TI - Angkatan 2019</p>
