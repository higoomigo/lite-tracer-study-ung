            ...
            <div class="space-y-6">
                ...
                <div x-show="employed === 'yes'" x-cloak class="space-y-6">
                    <div>
                        ...
                        <select id="industri" name="industri" class="mt-2 p-3 w-full bg-white border border-gray-300 rounded-md"
                            x-model="industri" :required="employed === 'yes'">
                            <option value="" disabled selected>Pilih salah satu</option>
                    ...
                    <div>
                        ...
                        <select id="status_pekerjaan" name="status_pekerjaan" class="mt-2 p-3 w-full bg-white border border-gray-300 rounded-md"
                    ...
                    <div>
                        ...
                        <input type="number" id="waktu_tunggu" name="waktu_tunggu" class="mt-2 p-3 w-full bg-white border border-gray-300 rounded-md"
                            placeholder="Masukkan waktu tunggu dalam bulan" x-model="waktu_tunggu" :required="employed === 'yes'">
                    </div>
                    <div>
                        ...
                        <select id="faktor_pekerjaan" name="faktor_pekerjaan" class="mt-2 p-3 w-full bg-white border border-gray-300 rounded-md"
                ...
                <div class="space-y-6">
                    ...
                    <div x-show="hasBusiness === 'yes'" x-cloak>
                        ...
                        <input type="text" name="business_name" class="p-3 w-full bg-white border border-gray-300 rounded-md"
                            x-model="business_name" :required="hasBusiness === 'yes'">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold mb-1">Apakah Anda tertarik untuk kembali ke sekolah melanjutkan pendidikan?</label>
                        <select name="interest_return_school" class="p-3 w-full bg-white border border-gray-300 rounded-md"
                ...
                <div x-show="employed === 'no'" x-cloak class="space-y-6">
                    ...
                    <div x-show="everEmployed === 'yes'" x-cloak class="space-y-6">
                        <div>
                            ...
                            <select name="last_job_title" class="p-3 w-full bg-white border border-gray-300 rounded-md"
                                x-model="last_job_title" :required="employed === 'no' && everEmployed === 'yes'">
                                <option value="" disabled selected>Pilih salah satu</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="last_company" class="p-3 w-full bg-white border border-gray-300 rounded-md"
                                x-model="last_company" :required="employed === 'no' && everEmployed === 'yes'">
                        </div>
                        <div>
                            ...
                            <select name="reason_left" class="p-3 w-full bg-white border border-gray-300 rounded-md"
                                x-model="reason_left" :required="employed === 'no' && everEmployed === 'yes'">
                                <option value="" disabled selected>Pilih salah satu</option>
                        ...
                        <div>
                            ...
                            <select name="current_activity" class="p-3 w-full bg-white border border-gray-300 rounded-md"
                                x-model="current_activity" :required="employed === 'no' && everEmployed === 'yes'">
                                <option value="" disabled selected>Pilih salah satu</option>
                    ...
                    <div x-show="everEmployed === 'no'" x-cloak class="space-y-6">
                        <div>
                            ...
                            <select name="never_employed_reason" class="p-3 w-full bg-white border border-gray-300 rounded-md"
                                x-model="never_employed_reason" :required="employed === 'no' && everEmployed === 'no'">
                                <option value="" disabled selected>Pilih salah satu</option>
                        ...
                        <div>
                            ...
                            <select name="never_employed_looking" class="p-3 w-full bg-white border border-gray-300 rounded-md"
                                x-model="never_employed_looking" :required="employed === 'no' && everEmployed === 'no'">
                                <option value="" disabled selected>Pilih salah satu</option>
                                <option value="yes">Ya</option>
                                <option value="no">Tidak</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="never_employed_business" class="p-3 w-full bg-white border border-gray-300 rounded-md"
                                x-model="never_employed_business" :required="employed === 'no' && everEmployed === 'no'">
                                <option value="" disabled selected>Pilih salah satu</option>
                                <option value="yes">Ya</option>
                                <option value="no">Tidak</option>
                    ...
                    <div x-show="everEmployed === 'yes' || everEmployed === 'no'" x-cloak class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="desired_industry" class="p-3 w-full bg-white border border-gray-300 rounded-md"
